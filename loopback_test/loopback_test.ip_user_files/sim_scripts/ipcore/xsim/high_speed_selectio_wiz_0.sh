...
#
# Script generated by Vivado on Fri Nov 15 13:16:17 +0100 2024
...
# script info
echo -e "high_speed_selectio_wiz_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L high_speed_selectio_wiz_v3_6_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot high_speed_selectio_wiz_0 xil_defaultlib.high_speed_selectio_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim high_speed_selectio_wiz_0 -key {Behavioral:sim_1:Functional:high_speed_selectio_wiz_0} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(high_speed_selectio_wiz_v3_6_9)
