...
design_libs_elab="-libname xpm -libname high_speed_selectio_wiz_v3_6_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm high_speed_selectio_wiz_v3_6_9 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work high_speed_selectio_wiz_v3_6_9 $xmvlog_opts \
